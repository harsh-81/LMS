...
import { resetAuthSlice, logout } from "../store/slices/authSlice"; // ✅ added logout
import Catalog from "../components/Catalog";
import { toggleAddNewAdminPopup,
         toggleSettingPopup,
  ...
  return (
    <>
      <aside
        ...
        } z-10 transition-all duration-700 md:relative md:left-0 flex w-64 bg-black text-white flex-col h-full`} // ✅ bg-black (not bg-blak)
      ...
      >
        ...
        <nav className="flex-1 px-6 space-y-2">
          ...
          >
            ...
            <span>Dashboard</span> {/* ✅ fixed label */}
          </button>
        ...
        <img
          ...
          className="h-fit w-fit absolute top-9 right-4 mt-4 block md:hidden"
        />
      </aside>
