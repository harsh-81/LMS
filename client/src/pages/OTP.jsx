    ...
    <>
      <div className="flex flex-col justify-center md:flex-row h-screen">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
          <Link
            to={"/register"}
            className="border-2 border-black rounded-3xl font-bold py-2 px-4 absolute top-5 left-5 
        ...
        <div className="hidden w-full md:w-1/2 bg-back text-white md:flex flex-col items-center justify-center p-8 rounded-tl-[80px] rounded-bl-[80px]">
          <div className="text-center h-[400px]">
            ...
            <p className="text-gray-700 mb-12">New to our platform? Sign up now.</p>
            <Link
              to={"/register"}
              className="border-2 mt-5 border-white px-8 w-full font-semibold bg-white text-black py-2 rounded-lg hover:bg-black hover:text-white transition"
            >
              SIGN UP
            </Link>
          </div>
...
//       <div className="flex flex-col justify-center md:flex-row h-screen">
//         {/* {LEFT SIDE} */}
//         <div className="w-full md:w-1/2 flex items-center jsutify-center bg-white p-8 relative">
//           <Link
//             to={"/register"}
